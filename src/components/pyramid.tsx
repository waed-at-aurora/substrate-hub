 ...
 * The Substrate layer carries the yellow wash — the active layer is
 * yellow per the extended Yellow Law, as is its dimension callout.
 */
	...
	return (
		...
		>
			<g fontFamily="var(--font-mono), monospace" fontSize="11" letterSpacing="0.08em">
				...
				<path
					d="M160 120 L400 120 L448 200 L112 200 Z"
					fill="color-mix(in srgb, var(--yellow) 22%, var(--paper))"
					stroke="var(--yellow)"
					strokeWidth="1.2"
				/>
				<text x="280" y="150" textAnchor="middle" fill="var(--yellow)" fontWeight="700" fontSize="13" letterSpacing="0.18em">
					SUBSTRATE
				</text>
				<text x="280" y="170" textAnchor="middle" fill="var(--ink-2)" fontSize="9.5">
					composite components · interaction patterns
				</text>
				<text x="280" y="186" textAnchor="middle" fill="var(--ink-2)" fontSize="9.5">
				...
				<text x="513" y="164" fill="color-mix(in srgb, var(--yellow) 70%, var(--muted))" fontSize="9" writingMode="tb" letterSpacing="0.1em">
					THIS SYSTEM
				</text>
			</g>
		</svg>
