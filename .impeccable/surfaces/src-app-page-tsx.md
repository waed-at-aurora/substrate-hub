...
Landing continuation (user-redesigned 2026-08-28; unified 2026-09-01; shooting lines reconnected 2026-09-01; corner-anchored half-circle source 2026-09-02): the hero and full-viewport Three.js tour share one uninterrupted drafting plate. The tour overlaps the hero so the real pyramid enters before the task actions leave. Two quiet guides tether the cursor-responsive ghost toward the desktop model field, while 28 deterministic shooting-star spokes originate from a source anchored at the landing component's lower-right corner and form a full left-facing half circle that overlaps into System Construction; the layer holds that corner without pointer parallax or scroll-scrubbed movement. Construction copy stays hidden until the model takes over, touch removes only the tethers, and reduced motion keeps the same hierarchy as a static document.
