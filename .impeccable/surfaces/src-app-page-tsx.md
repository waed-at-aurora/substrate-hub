...
Landing continuation (user-redesigned 2026-08-28; unified 2026-09-01; shooting lines reconnected 2026-09-01): the hero and full-viewport Three.js tour share one uninterrupted drafting plate. The tour overlaps the hero so the real pyramid enters before the task actions leave. Twenty-two deterministic shooting-star spokes originate at the model anchor and resolve visually into the pyramid top; mobile recenters that source over its centered model. Construction copy stays hidden until the landing body clears, and reduced motion preserves one quiet star frame while removing the overlap. The tour continues through Tokens → Primitives → Composites → Products with Anime.js scroll choreography, pointer orbit, raycast tier selection, keyboard/touch controls, live counts, and the final overview action.
